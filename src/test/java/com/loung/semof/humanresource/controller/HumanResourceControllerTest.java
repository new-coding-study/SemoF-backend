...
class HumanResourceControllerTest {
    ...
    public void setup() {
        mockMvc = MockMvcBuilders
                ...
                .build();
        plainRestTemplate = new RestTemplate();
    }
    ...
    void 사원_등록_테스트() throws SQLException {
        ...
        // 임의의 사진 입력 테스트를 하는 코드
        EmployeePhotoDto employeePhotoDto = EmployeePhotoDto.builder()
                .empNo(TEST_EMP_NO)
                .filePath("test/file/path")
                .originName("testOrigin.jpg")
                .changeName("testChange.jpg")
        ...
        // when
        ResponseEntity<ResponseDto> response =
                humanResourceController.insertEmployee(employeeDto, file);
    ...
    public void 사원_전체_조회_테스트() throws SQLException, UnsupportedEncodingException {
        ...
        employees.add(new EmployeeDto(1L, "안유진", "030601-4234567", "yujinAn@gmail.com", "010-1234-5678", "서울특별시 강남구"
                , 3000000,LocalDateTime.parse("2021-03-01 09:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")), null, "Y", "F", 4L, "PL", 1L,"ROLE_USER"));
        employees.add(new EmployeeDto(2L, "박지민", "000702-4345678", "parkjimin@gmail.com", "010-2345-6789", "서울특별시 강동구", 2800000
                , LocalDateTime.parse("2021-03-01 09:00:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")), null, "Y", "M", 5L, "HR", 1L,"ROLE_USER"));
        ...
        when(humanResourceService.selectEmployeeListWithPaging(anyInt(), anyInt())).thenReturn((List)employees);
    ...
    public void 사원_조건_선택_테스트() throws Exception {
        ...
        when(humanResourceService.selectEmployees(anyString(), anyString(), anyString()))
                .thenReturn((List)employeeDtoList);

        // when
        MvcResult mvcResult = mockMvc.perform(get("/employees/present/search?empName=김민지"))
